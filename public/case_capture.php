...
<table id="captureContainer" border=0 cellpadding=4 cellspacing=0 style="font: 11pt 'Arial';color:#ffffff;border-collapse:collapse;border:1px solid #ffffff">
		...
		<tr style="font: 11pt 'Arial';color:#ffffff">
			...
			<td valign=middle>
				<input type=text class="formField" id="mobile" name="mobile" style="text-align:center" placeholder="Reporter's Contact Number" onkeyup="checkInput(this)" disabled>
			</td>
		</tr>
		...
		<tr style="font: 11pt 'Arial';color:#ffffff">
			...
			<td valign=middle>
				<select class="formField" id="case_type" name="case_type">
					<option id="#ffffff" value=""> Please select ...
					<?php
		...
		<tr style="font: 11pt 'Arial';color:#ffffff">
			...
			<td valign=middle>
				<select class="formField" id="case_sub_type" name="case_sub_type">
				</select>
			</td>
		</tr>
		...
		<tr style="font: 11pt 'Arial';color:#ffffff">
			<td valign=middle>
			 	<textarea name="description" id="description" class="formField" wrap="physical" style="resize:none;height:100px;text-align:left" placeholder="Case details ..." onchange="this.value=toSentenceCase(this.value)"></textarea>
			</td>
		</tr>

...
$("#submitAssociatePoiForm").on("click",function(){
  ...
  $("#submitCreateCaseAgentForm").on("click",function(){
        ...
        var field_worker_id           = $("#CreateCaseAgentForm #fldHolderId").val();
        var house_holder_id           = $("#CreateCaseAgentForm #hseHolderId").val();
        var title                     = $("#CreateCaseAgentForm #title").val();
        var gender                    = $("#CreateCaseAgentForm #gender").val();
        ...
        var language                  = $("#CreateCaseAgentForm #language").val();
        ...
        var province                  = $("#CreateCaseAgentForm #province").val();
        var district                  = $("#CreateCaseAgentForm #district").val();
        var municipality              = $("#CreateCaseAgentForm #municipality").val();
        var ward                      = $("#CreateCaseAgentForm #ward").val();
        var area                      = $("#CreateCaseAgentForm #area").val();
        var token                     = $('input[name="_token"]').val();
        ...
        error: function(data) {
                    ...
                    $("#hse_error_title").html("");
                    $("#hse_error_gender").html("");
                    $("#hse_error_cellphone").html("");
                    $("#hse_error_name").html("");
                    $("#hse_error_surname").html("");
                    $("#hse_error_id_number").html("");
                    $("#hse_error_language").html("");
                    $("#hse_error_position").html("");
                    $("#hse_error_province").html("");
                    $("#hse_error_district").html("");
                    $("#hse_error_municipality").html("");
                    $("#hse_error_ward").html("");
                    $("#hse_error_priority").html("");
   ...
   function launchCaseModal(id,type)
    ...
    function launchUpdateUserModal(id)
    {
      ...
      if (url == "home") {
               ...
               $("#modalEditUser #province").attr("disabled","disabled");
